...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `live_stock`.`sheep`(`id`, `parent_id`, `breed`, `sex`, `color`, `offsprings`, `age`, `vaccination`, `disease`, `height`, `weight`, `food`, `wool_type`, `date_time`) VALUES ('$id','$parentId','$breed','$sex','$color','$offsprings','$age','$vaccination','$diseases','$height','$weight','$food','$wool_type',current_timestamp());";
    ...
    <form action="#" method="post" class="w3-container w3-card-4 w3-margin-top w3-twothird w3-display-topmiddle" style="border-radius: 5px; background-color:white; ">
        ...
        <p>
            ...
            <select class="w3-select w3-border" name="breed" id="Breed" style="border-radius: 5px" type="option">
                ...
                <option value="Chokla">Chokla</option>
                <option value="Patanwadi">Patanwadi</option>
                <option value="Avikalin">Avikalin</option>
                <option value="Jaisalmeri">Jaisalmeri</option>
        ...
        <p>
            ...
            <select class="w3-select w3-border" name="sex" id="Sex" style="border-radius: 5px" type="option">
                <option value="" disabled selected>Choose your option</option>
                <option value="ram">Male(ram)</option>
                <option value="ewe">Female(ewe)</option>
        ...
        <p>
            <label class="w3-text-grey">Wool type</label>
            <select class="w3-select w3-border" name="wool_type">
                <option value="" disabled selected>Choose your option</option>
                <option value="Fine Wool">Fine Wool</option>
                <option value="Medium Wool">Medium Wool</option>
                <option value="Long Wool">Long Wool</option>
                <option value="Down Wool">Down Wool</option>
                <option value="Crossed Wool">Crossbred Wool</option>
                <option value="Hair sheep">Hair Sheep</option>
