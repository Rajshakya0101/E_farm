...
<body style="background-color:#d5ede9;">
    ...
    ?>
    <div class="forms">
    <form autocomplete="off" action="#" method="post" class="w3-container w3-card-4 w3-margin-top w3-twothird w3-display-topmiddle" style="border-radius: 5px; background-color:white; ">
        <br>
        <p>
        ...
        <!-- Image Upload Field -->
        <p>
                <label class="w3-text-grey">Upload cow Image</label>
